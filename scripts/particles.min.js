...
var pJS = function(e, a) {
	...
	a && Object.deepExtend(i, a), (i.tmp.obj = {
		...
		i.retina_detect && window.devicePixelRatio > 1
			...
			: ((i.canvas.pxratio = 1), (i.tmp.retina = !1)), (i.canvas.w =
			i.canvas.el.offsetWidth * i.canvas.pxratio), (i.canvas.h =
			i.canvas.el.offsetHeight *
			i.canvas.pxratio), (i.particles.size.value =
			i.tmp.obj.size_value *
			i.canvas.pxratio), (i.particles.size.anim.speed =
			i.tmp.obj.size_anim_speed *
			i.canvas.pxratio), (i.particles.move.speed =
			i.tmp.obj.move_speed *
			i.canvas.pxratio), (i.particles.line_linked.distance =
			i.tmp.obj.line_linked_distance *
			i.canvas.pxratio), (i.interactivity.modes.grab.distance =
			i.tmp.obj.mode_grab_distance *
			i.canvas.pxratio), (i.interactivity.modes.bubble.distance =
			i.tmp.obj.mode_bubble_distance *
			i.canvas.pxratio), (i.particles.line_linked.width =
			i.tmp.obj.line_linked_width *
			i.canvas.pxratio), (i.interactivity.modes.bubble.size =
			i.tmp.obj.mode_bubble_size *
			i.canvas.pxratio), (i.interactivity.modes.repulse.distance =
			i.tmp.obj.mode_repulse_distance * i.canvas.pxratio);
	}), (i.fn.canvasInit = function() {
		i.canvas.ctx = i.canvas.el.getContext('2d');
	}), (i.fn.canvasSize = function() {
		(i.canvas.el.width = i.canvas.w), (i.canvas.el.height =
			i.canvas.h), i &&
		...
		(this.opacity =
			...
			i.particles.opacity.value), i.particles.opacity.anim.enable &&
			(
		...
		if ('image' == this.shape) {
			...
			}), this.img.ratio || (this.img.ratio = 1), 'svg' ==
				i.tmp.img_type &&
		...
		i.canvas.ctx.closePath(), i.particles.shape.stroke.width > 0 &&
			(
		...
		for (var e = 0; e < i.particles.array.length; e++) {
					...
					i.particles.size.anim.enable &&
						(
							1 == a.size_status
								...
								: (
										a.radius <=
											i.particles.size.anim.size_min &&
											(a.size_status = !0),
										(a.radius -= a.vs)
									),
			...
			switch ((
				...
				case 'bounce':
					a.x + a.radius > i.canvas.w
						? (a.vx = -a.vx)
						: a.x - a.radius < 0 && (a.vx = -a.vx), a.y + a.radius >
					i.canvas.h
						? (a.vy = -a.vy)
			...
			if (
				...
				for (var n = e + 1; n < i.particles.array.length; n++) {
					...
					i.particles.line_linked.enable &&
						i.fn.interact.linkParticles(a, r), i.particles.move
						.attract.enable &&
						i.fn.interact.attractParticles(a, r), i.particles.move
						.bounce && i.fn.interact.bounceParticles(a, r);
				}
		}
		...
		cancelRequestAnimFrame(i.fn.checkAnimFrame), cancelRequestAnimFrame(
			i.fn.drawAnimFrame
		...
		if (n <= i.particles.line_linked.distance) {
			...
			if (r > 0) {
				...
				(i.canvas.ctx.strokeStyle =
					...
					i.particles.line_linked.width), i.canvas.ctx.beginPath(), i.canvas.ctx.moveTo(
					e.x,
					e.y
				), i.canvas.ctx.lineTo(
					a.x,
		...
		i.particles.array.splice(0, e), i.particles.move.enable ||
			i.fn.particlesDraw();
			...
			if (a != t)
				if (i.tmp.bubble_duration_end) {
					...
					if (v != a) {
						...
						'size' == c && (e.radius_bubble = d), 'opacity' == c &&
							(e.opacity_bubble = d);
					}
				} else
					'size' == c && (e.radius_bubble = void 0), 'opacity' == c &&
		...
		if (
			...
			if (i.tmp.bubble_clicking) {
				...
				p > i.interactivity.modes.bubble.duration &&
					(i.tmp.bubble_duration_end = !0), p >
					2 * i.interactivity.modes.bubble.duration &&
					(
		...
		function a() {
			...
			if (
				...
				t.x + e.radius > i.canvas.w
					? (e.vx = -e.vx)
					: t.x - e.radius < 0 && (e.vx = -e.vx), t.y + e.radius >
				i.canvas.h
					? (e.vy = -e.vy)
		...
		'window' == i.interactivity.detect_on
			...
			: (i.interactivity.el = i.canvas.el), (i.interactivity.events
			.onhover.enable ||
			i.interactivity.events.onclick.enable) &&
			(
		...
		i.fn.retinaInit(), i.fn.canvasInit(), i.fn.canvasSize(), i.fn.canvasPaint(), i.fn.particlesCreate(), i.fn.vendors.densityAutoParticles(), (i.particles.line_linked.color_rgb_line = hexToRgb(
...
(Object.deepExtend = function(e, a) {
	...
	'string' != typeof e && ((a = e), (e = 'particles-js')), e ||
		(e = 'particles-js');
